...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 03, 2023 lúc 10:49 AM
...
INSERT INTO `nguoidung` (`User_id`, `Username`, `Email`, `Pass`, `Created_at`) VALUES
...
--
ALTER TABLE `theloai`
  MODIFY `ma_tloai` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
